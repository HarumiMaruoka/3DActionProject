...
public class Old_PlayerAttack : MonoBehaviour
{
    ...
    //<===== インスペクタから設定すべき値 =====>
    [Header("アニメーションパラメータの名前 : メインウエポンの int Parameter Name"), SerializeField] string _animParameterName_int_MainWeaponID = "MainWeaponID";
    [Header("アニメーションパラメータの名前 : サブウエポンの   int Parameter Name"), SerializeField] string _animParameterName_int_SubWeaponID = "SubWeaponID";
    [Header("アニメーションパラメータの名前 : メインウエポンの bool Parameter Name"), SerializeField] string _animParameterName_bool_MainWeaponName = "Fire1";
    [Header("アニメーションパラメータの名前 : サブウエポンの   bool Parameter Name"), SerializeField] string _animParameterName_bool_SubWeaponName = "Fire2";
